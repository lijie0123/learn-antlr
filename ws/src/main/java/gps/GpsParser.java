...
public class GpsParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "Gps.g4"; }
	...
	public GpsParser(TokenStream input) {
		super(input);
	...
	public static class FileContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GpsListener ) ((GpsListener)listener).enterFile(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GpsListener ) ((GpsListener)listener).exitFile(this);
		}
	}
	...
	public static class GroupContext extends ParserRuleContext {
		public Token INT;
		public TerminalNode INT() { return getToken(GpsParser.INT, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GpsListener ) ((GpsListener)listener).enterGroup(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GpsListener ) ((GpsListener)listener).exitGroup(this);
		}
	}
	...
	public static class SequenceContext extends ParserRuleContext {
		public int n;
		public int i = 1;;
		public List<TerminalNode> INT() { return getTokens(GpsParser.INT); }
		public TerminalNode INT(int i) {
			return getToken(GpsParser.INT, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GpsListener ) ((GpsListener)listener).enterSequence(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GpsListener ) ((GpsListener)listener).exitSequence(this);
		}
	}
